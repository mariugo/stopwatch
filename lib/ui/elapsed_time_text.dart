...
class ElapsedTimeText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        TimeDigit(
          text: minutesStr.substring(0, 1),
          width: digitWidth,
        ),
        TimeDigit(
          text: minutesStr.substring(1, 2),
          width: digitWidth,
        ),
        const TimeDigit(
          text: ':',
        ...
        TimeDigit(
          text: secondsStr.substring(0, 1),
          width: digitWidth,
        ),
        TimeDigit(
          text: secondsStr.substring(1, 2),
          width: digitWidth,
        ),
        const TimeDigit(
          text: '.',
        ...
        TimeDigit(
          text: hundredsStr.substring(0, 1),
          width: digitWidth,
        ),
        TimeDigit(
          text: hundredsStr.substring(1, 2),
          width: digitWidth,
        ),
      ],
    );
